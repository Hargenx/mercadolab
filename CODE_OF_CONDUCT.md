...
1) Rigor acadêmico  
   Dados, argumentos e propostas devem ser sustentados por lógica e evidência técnica.  
   Em caso de divergência, o critério é o rigor — não a hierarquia pessoal.

2) Reprodutibilidade  
   Contribuições devem buscar aumentar, não reduzir, a capacidade de reprodução de resultados.
...
4) Respeito e cordialidade  
   Propostas técnicas podem ser rejeitadas.  
   Pessoas não são rejeitadas.

5) Responsabilidade sobre afirmações técnicas  
   Afirmações devem ser verificáveis, testáveis e — quando aplicável — mensuráveis.
...
Conflitos técnicos devem ser resolvidos com:

1. evidência empírica (benchmarks, testes, perf)  
2. argumentação formal  
